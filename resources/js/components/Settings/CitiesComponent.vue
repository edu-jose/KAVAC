<template>
	<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mt-2 mb-2 text-center">
		...
		<div class="modal fade text-left" tabindex="-1" id="add_city">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-12 col-md-6">
								<div class="form-group is-required">
									...
									<select2
                                        ...
                                        v-model="record.country_id" id="cityCountry"
                                    ></select2>
							...
							<div class="col-12 col-md-6">
								<div class="form-group is-required">
                                    <label for="cityEstate">Estados:</label>
                                    <select2
                                        id="cityEstate"
							...
							<div class="col-12">
								<div class="form-group is-required">
									...
									<input
										...
										title="Indique el nombre de la ciudad (requerido)" id="cityName"
	                ...
	                <div class="modal-footer">
	                	<div class="form-group">
							...
							<button
                                type="button" @click="createRecord('cities')"
	                ...
	                <div class="modal-body modal-table">
	                	<v-client-table :columns="columns" :data="records" :options="table_options">
	                		<div slot="id" slot-scope="props" class="text-center">
		                		...
		                		<button
                                    @click="deleteRecord(props.row.id, 'cities')"
