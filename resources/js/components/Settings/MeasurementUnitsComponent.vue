<template>
	<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mt-2 mb-2 text-center">
		...
		<div class="modal fade text-left" tabindex="-1" id="add_measurement_unit">
				...
				<div class="modal-content">
						...
						<div class="row">
							<div class="col-12 col-md-2">
								<div class="form-group is-required">
									<label for="measurementUnitAcronym">Acrónimo:</label>
									<input
                                        id="measurementUnitAcronym"
                                        type="text" placeholder="Acrónimo" data-toggle="tooltip"
							...
							<div class="col-12 col-md-4">
								<div class="form-group is-required">
									<label for="measurementUnitName">Nombre:</label>
									<input
							...
							<div class="col-12 col-md-6">
								<div class="form-group is-required">
									<label for="measurementUnitDescription">Descripción:</label>
									<input
	                ...
	                <div class="modal-footer">
	                	<div class="form-group">
							...
							<button
                                type="button" @click="createRecord('measurement-units')"
	                ...
	                <div class="modal-body modal-table">
	                	<v-client-table :columns="columns" :data="records" :options="table_options">
	                		<div slot="id" slot-scope="props" class="text-center">
		                		...
		                		<button
                                    @click="deleteRecord(props.row.id, 'measurement-units')"
