<template>
	<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mt-2 mb-2 text-center">
		...
		<div class="modal fade text-left" tabindex="-1" id="add_institution_sector">
				...
				<div class="modal-content">
						...
						<div class="row">
							<div class="col-12">
								<div class="form-group is-required">
									<label for="institutionSectorName">Nombre:</label>
									<input
                                        id="institutionSectorName"
                                        type="text" placeholder="Nombre del sector" data-toggle="tooltip"
	                ...
	                <div class="modal-footer">
	                	<div class="form-group">
							...
							<button
                                type="button" @click="createRecord('institution-sectors')"
	                ...
	                <div class="modal-body modal-table">
	                	<v-client-table :columns="columns" :data="records" :options="table_options">
	                		<div slot="id" slot-scope="props" class="text-center">
		                		...
		                		<button
                                    @click="deleteRecord(props.row.id, 'institution-sectors')"
