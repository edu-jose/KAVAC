...
<table cellspacing="0" cellpadding="1" border="1">
    <tr align="C" style="background-color: #cfcfcf;">
        ...
        <th width="12%">Código de solicitud</th>
    ...
    @foreach($fields as $field)
        <tr>
            ...
            <td width="15%">
                {{ 
                    date_format(new DateTime($field->warehouseRequest->request_date), 'd-m-Y') ??
                        date_format($field->created_at, "d/m/Y") 
                }}
            </td>
            ...
            <td width="12%"> {{ $field->warehouseRequest
                ? ($field->warehouseRequest->code)
                : ($field->code ) }} </td>
