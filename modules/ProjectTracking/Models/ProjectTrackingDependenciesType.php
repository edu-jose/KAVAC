...
/**
 * @class Dependency
 * @brief Datos de tipos de dependencia
 *
 * Gestiona el modelo de datos para los tipos de dependencia
 *
 ...
 */
class ProjectTrackingDependenciesType extends Model implements Auditable
{
    use SoftDeletes;
    use AuditableTrait;
    use ModelsTrait;
