    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 mt-2 mb-2 text-center">
      <a
        ...
        @click="
          addRecord(
            'add_task_types',
            'projecttracking/task-types',
            $event
          )
        "
      >
        <i class="icofont icofont-checked ico-3x"></i>
        ...
        <div class="modal-dialog vue-crud" role="document">
           <div class="modal-content">
            <div class="modal-header">
              ...
              <h6>
                <i class="icofont icofont-checked inline-block ico-3x"></i>
                Tipo de Tareas
              </h6>
            </div>
                ...
                <div class="col-md-4">
                  <div class="form-group is-required">
                    ...
                    <input
                      ...
                      placeholder="Nombre"
                      data-toggle="tooltip"
                      title="Indique el nombre del tipo de la tarea"
                ...
                <div class="col-md-4">
                  <div>
                    ...
                    <input
                      ...
                      data-toggle="tooltip"
                      title="Indique la descripción del tipo de tarea"
                    />
                  </div>
                </div>
                <div class="col-md-4">
                  <div>
                    ...
                    <div class="row">
                      <input
                        ...
                        data-toggle="tooltip"
                        title="Indique el color del tipo de la tarea"
            ...
            <div class="modal-footer">
              <div class="form-group">
                ...
                <button
                  type="button"
                  @click="createRecord('projecttracking/task-types')"
