           ...
           <div class="modal-content">
                ...
                <div class="col-md-4">
                  <div class="form-group is-required">
                    ...
                    <input
                      ...
                      placeholder="Nombre"
                      data-toggle="tooltip"
                      title="Indique el nombre del tipo de la actividad"
                ...
                <div class="col-md-4">
                  <div>
                    ...
                    <input
                      ...
                      data-toggle="tooltip"
                      title="Indique la descripción del tipo de actividad"
                    />
                  </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="modal-footer">
              <div class="form-group">
                ...
                <button
                  type="button"
                  @click="createRecord('projecttracking/activity-type')"
