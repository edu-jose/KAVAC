    ...
    <section>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="form-group">
                        ...
                        <input
                            ...
                            :value="record.budget_common_budgetary_availability?.code"
                        />
                    </div>
                </div>
                <div class="col-3">
        ...
        <div class="card-footer text-right">
            <button
                ...
                @click="createRecord('/budget/budgetary_availability', 1)"
            >
                Hay disponibilidad
            </button>
            <button
...
export default {
    ...
    methods: {
        ...
        uploadComplete() {
            const vm = this;
            vm.loading = true;
            vm.createRecord("/budget/budgetary_availability", 1);
            vm.loading = false;
        },
