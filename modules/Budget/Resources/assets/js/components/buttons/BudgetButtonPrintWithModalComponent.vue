<template>
    <span>
      ...
      <button
        @click="showModal(`currency_report_${id}`, $event)"
        class="btn btn-sm btn-primary btn-custom btn-print-general" style="margin-right: 3rem;"
  ...
  export default {
    ...
    methods: {
      ...
      generateReport() {
        ...
        $(`#currency_report_${vm.id}`).modal("hide");
        vm.reset()
      },
