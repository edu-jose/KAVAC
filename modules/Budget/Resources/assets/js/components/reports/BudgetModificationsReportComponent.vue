    ...
    <div class="form-horizontal">
        ...
        <div class="card-footer text-right">
            <button
                ...
                id="budgetModificationsGenerateReport"
            >
            ...
            <button
                ...
                id="budgetModificationsExportReport"
            >
...
export default {
    ...
    data() {
        return {
            ...
            documentStatusArray: JSON.parse(this.documentStatuses),
            modificationsArray: JSON.parse(this.modifications),
            errors: [],
            specific_actions: [],
        };
    },
    ...
    methods: {
        reset() {
            ...
            vm.finalDate = "",
            vm.project_id = "",
            vm.currency_id = this.currencies[0].id,
            vm.modification_id = "",
            vm.document_status_id = "",
            vm.centralized_action_id = "",
            vm.modification_id = "";
        ...
        async generateReport(exportReport) {
            this.errors = [];
            if (!this.modification_id) {
                this.errors.push(
                    "El campo Modificaciones es obligatorio"
                );
            }
            if (!this.currency_id) {
                this.errors.push(
