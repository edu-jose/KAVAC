...
class BudgetRoleAndPermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            [
                'name' => 'Visualizar  configuración del módulo de presupuesto',
            ...
            [
                'name' => 'Modificar cuenta presupuestaria',
                'slug' => 'budget.account.edit',
                'description' => 'Acceso para modificar cuenta presupuestaria',
                'model' => 'Modules\Budget\Models\BudgetAccount',
                'model_prefix' => 'presupuesto',
                'slug_alt' => 'clasificador.modificar',
                'short_description' => 'modificar clasificador',
            ],
            [
            ...
            [
                'name' => 'Visualizar  cuentas presupuestarias',
            ...
            [
                ...
                'description' => 'Acceso para modificar proyectos',
                'model' => 'Modules\Budget\Models\BudgetProject', 'model_prefix' => 'presupuesto',
                'slug_alt' => 'proyecto.modificar', 'short_description' => 'modificar proyecto',
            ],
            [
            ...
            [
                'name' => 'Modificar acción centralizada',
                'slug' => 'budget.centralizedaction.edit',
                'description' => 'Acceso para modificar acción centralizada',
                'model' => 'Modules\Budget\Models\BudgetCentralizedAction', 'model_prefix' => 'presupuesto',
                'slug_alt' => 'accion_centralizada.modificar', 'short_description' => 'modificar acción centralizada',
            ],
            [
            ...
            [
                'name' => 'Visualizar  acciones centralizadas',
            ...
            [
                'name' => 'Modificar acción específica',
                'slug' => 'budget.specificaction.edit',
                'description' => 'Acceso para modificar acciones específicas',
                'model' => 'Modules\Budget\Models\BudgetSpecificAction', 'model_prefix' => 'presupuesto',
                'slug_alt' => 'accion_especifica.modificar', 'short_description' => 'modificar acción específica',
            ],
            [
            ...
            [
                'name' => 'Visualizar  acciones específicas',
            ...
            [
                'name' => 'Modificar formulación de presupuesto',
                'slug' => 'budget.formulation.edit',
                'description' => 'Acceso para modificar formulaciones de presupuesto',
                'model' => 'Modules\Budget\Models\BudgetFormulation', 'model_prefix' => 'presupuesto',
                'slug_alt' => 'formulacion.modificar', 'short_description' => 'modificar formulación',
            ],
            [
            ...
            [
                'name' => 'Visualizar  formulaciones de presupuesto',
            ...
            [
                'name' => 'Modificar crédito adicional',
                'slug' => 'budget.aditionalcredit.edit',
                'description' => 'Acceso para modificar créditos adicionales',
                'model' => 'Modules\Budget\Models\BudgetModification', 'model_prefix' => 'presupuesto',
                'slug_alt' => 'credito_adicional.modificar', 'short_description' => 'modificar crédito adicional',
            ],
            [
            ...
            [
                'name' => 'Visualizar  créditos adicionales',
            ...
            [
                'name' => 'Modificar reducción de presupuesto',
                'slug' => 'budget.reduction.edit',
                'description' => 'Acceso para modificar reducciones de presupuesto',
                'model' => 'Modules\Budget\Models\BudgetModification', 'model_prefix' => 'presupuesto',
                'slug_alt' => 'reduccion.modificar', 'short_description' => 'modificar reducción de presupuesto',
            ],
            [
            ...
            [
                'name' => 'Visualizar  reducciones de presupuesto',
            ...
            [
                'name' => 'Modificar traspaso de presupuesto',
                'slug' => 'budget.transfer.edit',
                'description' => 'Acceso para modificar traspasos de presupuesto',
                'model' => 'Modules\Budget\Models\BudgetModification',
                'model_prefix' => 'presupuesto',
                'slug_alt' => 'traspaso.modificar',
                'short_description' => 'modificar traspaso de presupuesto',
            ],
            [
            ...
            [
                'name' => 'Visualizar  traspasos de presupuesto',
            ...
            [
                'name' => 'Modificar modificación presupuestaria',
                'slug' => 'budget.modifications.edit',
                'description' => 'Acceso para modificar modificaciones presupuestarias',
                'model' => 'Modules\Budget\Models\BudgetModification',
                'model_prefix' => 'presupuesto',
                'slug_alt' => 'modificacion.modificar',
                'short_description' => 'modificar modificación presupuestaria',
            ],
            [
            ...
            [
                'name' => 'Visualizar  modificaciones presupuestarias',
            ...
            [
                'name' => 'Modificar un tipo de financiamiento',
                'slug' => 'budget.financementtypes.update',
                'description' => 'Acceso para modificar un tipo de financiamiento',
                'model' => 'Modules\Budget\Models\BudgetFinancementTypes',
                'model_prefix' => 'presupuesto',
                'slug_alt' => 'tipos_financiamiento.modificar',
                'short_description' => 'modificar un tipo de financiamiento',
            ],
            [
            ...
            [
                'name' => 'Modificar una fuente de financiamiento',
                'slug' => 'budget.financementsources.update',
                'description' => 'Acceso para modificar una fuente de financiamiento',
                'model' => 'Modules\Budget\Models\BudgetFinancementSources',
                'model_prefix' => 'presupuesto',
                'slug_alt' => 'fuentes_financiamiento.modificar',
                'short_description' => 'modificar una fuente de financiamiento',
            ],
            [
            ...
            [
                'name' => 'Modificar Compromisos',
                'slug' => 'budget.compromise.update',
                'description' => 'Acceso para modificar Compromisos',
                'model' => BudgetCentralizedAction::class, 'model_prefix' => 'presupuesto',
                'slug_alt' => 'compromisos.modificar',
                'short_description' => 'modificar Compromisos',
            ],
            [
            ...
            [
                'name' => 'Obtener Reporte Disponibilidad Presupuestaria',
                'slug' => 'budget.budgetavailability.report.index',
                'description' => 'Acceso para obtener Reporte Disponibilidad Presupuestaria',
                'model' => '',
                'model_prefix' => 'presupuesto',
                'slug_alt' => 'budgetAvailability.listado',
                'short_description' => 'Acceder al Reporte Disponibilidad Presupuestaria',
            ],
            [
                'name' => 'Obtener Reporte Presupuesto Formulado',
                'slug' => 'budget.formulated.report.index',
                'description' => 'Acceso para obtener Reporte Presupuesto Formulado',
                'model' => '',
                'model_prefix' => 'presupuesto',
                'slug_alt' => 'formulated.report',
                'short_description' => 'Acceder al Reporte Presupuesto Formulado',
            ],
            [
                'name' => 'Obtener Reporte Consolidado',
                'slug' => 'budget.consolidated.report.index',
                'description' => 'Acceso para obtener Reporte Consolidado',
                'model' => '',
                'model_prefix' => 'presupuesto',
                'slug_alt' => 'budgetConsolidated.listado',
                'short_description' => 'Acceder al Reporte Consolidado',
            ],
            [
                'name' => 'Obtener Reporte de Compromisos',
                'slug' => 'budget.compromisos.report.index',
                'description' => 'Acceso para obtener Reporte de Compromisos',
                'model' => '',
                'model_prefix' => 'presupuesto',
                'slug_alt' => 'budgetCompromisos.listado',
                'short_description' => 'Acceder al Reporte de Compromisos',
            ],
            [
                'name' => 'Obtener Reporte de Modificaciones',
                'slug' => 'budget.modification.report.index',
                'description' => 'Acceso para obtener Reporte de Modificaciones',
                'model' => '',
                'model_prefix' => 'presupuesto',
                'slug_alt' => 'budgetModificationReport.listado',
                'short_description' => 'Acceder al Reporte de Modificaciones',
            ],
            [
