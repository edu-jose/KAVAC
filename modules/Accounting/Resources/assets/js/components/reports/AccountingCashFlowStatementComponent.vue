<template>
    <div class="form-horizontal">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-3" id="helpCashFlowStatementMonth">
                ...
                <div class="col-3" id="helpCashFlowStatementYear">
                    <div class="form-group">
                        <label class="control-label">Año</label>
                        <select2 :options="years" v-model="year_init"></select2>
                    </div>
                </div>
                <div class="col-3" id="helpCashFlowStatementCurrency">
                    <div class="form-group">
...
export default {
    ...
    data() {
        return {
            ...
            url: `${window.app_url}/accounting/report/cashFlowStatement/pdf/`,
            urlSign: `${window.app_url}/accounting/report/cashFlowStatementSign/pdf/`,
            currencies: [],
            currency_id: "",
            zero_accounts: false,
        };
