...
/**
 * @class CreatePayrollSavingsFundsTable
 ...
 */
class CreatePayrollSavingsFundsTable extends Migration
{
    /**
    ...
    public function up()
    {
        Schema::create('payroll_savings_funds', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('payroll_savings_funds');
    }
}
