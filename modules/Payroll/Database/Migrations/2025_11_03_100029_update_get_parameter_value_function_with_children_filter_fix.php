...
/**
 * @class UpdateGetParameterValueFunctionWithChildrenFilterFix
 ...
 */
class UpdateGetParameterValueFunctionWithChildrenFilterFix extends Migration
{
    /**
    ...
    public function up()
    {
        ...
        $funcArray = ["get_parameter_value", "process_formula", "process_parameter_formula"];
        ...
        foreach ($funcArray as $func) {
            ...
            foreach ($functions as $function) {
                $dropStatement = "DROP FUNCTION IF EXISTS {$function->proname}({$function->args})";
            ...
            BEGIN
                ...
                IF POSITION('NUMBER_CHILDREN' IN formula_text) > 0 THEN
                    ...
                    BEGIN
                        ...
                        FROM filter_payroll_staff_children(current_staff_id, concept_id, period_end);
