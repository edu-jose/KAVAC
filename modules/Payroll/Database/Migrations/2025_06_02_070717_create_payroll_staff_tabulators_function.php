...
/**
 * @class CreatePayrollStaffTabulatorsFunction
 ...
 */
class CreatePayrollStaffTabulatorsFunction extends Migration
{
    /**
    ...
    public function up()
    {
        ...
        DB::statement('DROP FUNCTION IF EXISTS payroll_staff_tabulators_function(integer, integer, integer, integer, date, date)');
        ...
        DB::statement("
            ...
            BEGIN
                ...
                LEFT JOIN
                    payroll_tabulators_function(period_start, period_end) AS ptv ON TRUE
                LEFT JOIN
                    payroll_salary_adjustments AS psa ON psa.payroll_salary_tabulator_id = ptv.tabulator_id
                WHERE
        ...
        DB::statement("
            ...
            BEGIN
                ...
                SELECT
                    ...
                    CASE
                        WHEN psa.increase_of_type = 'absolute' THEN (scales.value + psa.value)::NUMERIC
                        WHEN psa.increase_of_type = 'percentage' THEN ((scales.value * psa.value) / 100)::NUMERIC
                        WHEN psa.increase_of_type = 'different' THEN (
                            SELECT 
    ...
    {
        DB::statement('DROP FUNCTION IF EXISTS public.payroll_staff_tabulators_function(integer, integer, integer, integer, date, date)');
