...
/**
 * @class CreatePayrollStaffFilterParametersView
 ...
 */
class CreatePayrollStaffFilterParametersView extends Migration
{
    /**
    ...
    {
        DB::statement('DROP VIEW IF EXISTS payroll_staff_filter_parameters_view');
    }
}
