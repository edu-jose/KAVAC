...
use Modules\Payroll\Imports\WageGarnishmentsImport;
 ...
 */
class PayrollWageGarnishmentsImportJob implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        Excel::import(new WageGarnishmentsImport(), $this->file, null, \Maatwebsite\Excel\Excel::XLSX);
