...
use Modules\Payroll\Imports\SavingsFundImport;
 ...
 */
class PayrollSavingsFundImportJob implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        Excel::import(new SavingsFundImport(), $this->file, null, \Maatwebsite\Excel\Excel::XLSX);
