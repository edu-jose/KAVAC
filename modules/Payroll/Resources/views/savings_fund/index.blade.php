            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-btns">
                        ...
                        @include('buttons.new', ['route' => route('payroll.savings-fund.create')])
                ...
                <div class="card-body">
                    <payroll-savings-list route_list="{{ url('payroll/get-savings-fund') }}"
                        route_edit="{{ url('payroll/edit-savings-fund') }}"
                        route_delete="{{ url('payroll/delete-savings-fund') }}">
                    </payroll-savings-list>
                </div>
            </div>
        </div>
    </div>
...
@section('extra-js')
    <script type="text/javascript" nonce="{{ session()->get('nonce') }}">
        ...
        function exportData() {
            location.href = `${window.app_url}/payroll/savings-fund/export`;
        }

        function importData() {
            var url = `${window.app_url}/payroll/savings-fund/import`;
