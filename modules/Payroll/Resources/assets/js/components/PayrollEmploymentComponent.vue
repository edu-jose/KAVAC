            ...
            <div class="row">
                <div class="col-md-4" id="helpEmploymentStaff">
                    <div class="form-group is-required">
                        ...
                        <select2 :options="payroll_staffs" v-model="record.payroll_staff_id" :disabled="isEditMode">
                        </select2>
                        <input type="hidden" v-model="record.id">
                    </div>
                </div>
                <div :class="[record.active ? 'col-md-4' : 'col-md-2']" id="helpEmploymentIsActive">
                ...
                <div v-show="record.active == false" class="col-md-2" id="helpEmploymentIsReleaseCharge">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="custom-control custom-switch" data-toggle="tooltip" title="
                                ...
                                ">
                                <input type="checkbox" class="custom-control-input" id="release_charge"
                                    name="release_charge" v-model="record.release_charge">
                                <label class="custom-control-label" for="release_charge"></label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div v-show="record.active == false" class="col-md-4" id="helpEmploymentEndDate">
                    <div class="form-group">
                        ...
                        <input @input="time_worked(); diff_datetimes(record.start_date);" type="date"
                            class="form-control input-sm" v-model="record.end_date" :max="fiscal_date" />
                    </div>
                </div>
                <div class="col-md-4" v-if="!record.active">
                    <div class="form-group is-required">
                        <label>Tipo de Inactividad:</label>
                        <select2 :options="payroll_inactivity_types" v-model="record.payroll_inactivity_type_id">
                        </select2>
                    </div>
                </div>
                <div class="col-md-4" id="helpEmploymentEmail">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control input-sm" v-model="record.institution_email" />
                    </div>
                </div>
                <div class="col-md-4" id="helpEmploymentPossitionType">
                    <div class="form-group is-required">
                        <label>Tipo de Cargo:</label>
                        <select2 :options="payroll_position_types" v-model="record.payroll_position_type_id">
                        </select2>
                    </div>
                </div>
                <div class="col-md-4" id="helpEmploymentPossition">
                    <div class="form-group is-required">
                        <label>Cargo:</label>
                        <select2 :options="payroll_positions" v-model="record.payroll_position_id"
                            @input="setPayrollWorkload()">
                        </select2>
                    </div>
                </div>
                <div class="col-md-4" id="helpEmploymentWorkload" v-if="record.payroll_position_id && payroll_workload">
                    <div class="form-group">
                        <label>Carga horaria:</label>
                        <br>
                        <span>{{ payroll_workload }}</span>
                    </div>
                </div>
                <div class="col-md-4" id="helpEmploymentCoordination">
                    <div class="form-group">
                        <label>Coordinación:</label>
                        <select2 :options="payroll_coordinations" v-model="record.payroll_coordination_id"></select2>
                    </div>
                </div>
                <div class="col-md-4" id="helpEmploymentStaffType">
                    <div class="form-group is-required">
                        <label>Tipo de Personal:</label>
                        <select2 :options="payroll_staff_types" v-model="record.payroll_staff_type_id">
                        </select2>
                    </div>
                </div>
                <div class="col-md-4" id="helpEmploymentContractType">
                    <div class="form-group is-required">
                        ...
                        <select2 :options="payroll_contract_types" v-model="record.payroll_contract_type_id">
                        </select2>
                    </div>
                </div>
                ...
                <div class="col-md-4" id="helpEmploymentInstitution">
                    <div class="form-group is-required">
                        ...
                        <select2 :options="institutions" @input="getDepartments()" v-model="record.institution_id">
                        </select2>
                    </div>
                </div>
                <div class="col-md-4" id="helpEmploymentDepartment">
                    <div class="form-group is-required">
                        ...
                        <select2 :options="departments" v-model="record.department_id" id="department"></select2>
                    </div>
                </div>
                ...
                <div class="col-12" id="helpEmploymentFunction">
                    <div class="form-group">
                        ...
                        <ckeditor :editor="ckeditor.editor" id="function_description" data-toggle="tooltip"
                            title="Indique una descripción para las funciones" :config="ckeditor.editorConfig"
                            class="form-control" name="function_description" tag-name="textarea" rows="3"
                ...
                <div class="col-md-12" id="helpEmploymentPreviousJobs">
                    ...
                    <h6 class="card-title">
                        Trabajos anteriores
                        <i class="fa fa-plus-circle cursor-pointer" @click="addPreviousJob()"></i>
                    </h6>
                    <div class="row" v-for="(job, index) in record.previous_jobs" :key="index">
                        <div class="col-md-4">
                            <div class="form-group is-required">
                                ...
                                <input type="text" id="organization_name" class="form-control input-sm"
                                    data-toggle="tooltip" title="Nombre de la organización"
                        ...
                        <div class="col-md-4" v-if="payroll_sector_types.length > 0">
                            <div class="form-group is-required">
                                <label>Tipo de sector:</label>
                                <select2 :options="payroll_sector_types" v-model="job.payroll_sector_type_id" @input="
                        ...
                        <div class="col-md-4">
                            <div class="form-group is-required">
                                <label>Cargo:</label>
                                <input type="text" id="previous_position" class="form-control input-sm"
                                    data-toggle="tooltip" title="Cargo" v-model="job.previous_position">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group is-required">
                                <label>Tipo de Personal:</label>
                                <select2 :options="payroll_staff_types" v-model="job.payroll_staff_type_id">
                                </select2>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group is-required">
                                ...
                                " type="date" class="form-control input-sm" v-model="job.start_date"
                                    :max="fiscal_date" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group is-required">
                                ...
                                <input @change="
                                    antiquity();
                                diff_datetimes(record.start_date);
                                " type="date" class="form-control input-sm" v-model="job.end_date"
                                    :max="fiscal_date" />
                            </div>
                        </div>
                        <div class="col-1">
                            <div class="form-group">
                                <button class="mt-4 btn btn-sm btn-danger btn-action" type="button" @click="
            ...
            <div class="row">
                ...
                <div class="col-md-4" id="helpEmploymentYears">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-sm" v-model="record.years_apn" disabled="true" />
                    </div>
                </div>
                <div v-if="record.active" class="col-md-4" id="helpEmploymentYears">
                    <div class="form-group">
                        <label>
                            Tiempo laborando en la institución/organización (calculada en base a la fecha {{
                                now }}):
                        </label>
                        <input type="text" class="form-control input-sm" v-model="record.institution_years"
                            disabled="true" />
                    </div>
                </div>
                <div v-else class="col-md-4" id="helpEmploymentYears">
                    <div class="form-group">
                        <label>
                            Tiempo laborado en la institución/organización:
                        </label>
                        <input type="text" class="form-control input-sm" v-model="record.time_worked" disabled="true" />
                    </div>
                </div>
                <div class="col-md-4" id="helpEmploymentYears">
                    <div class="form-group">
                        <label>Total años de servicio:</label>
                        <input type="text" class="form-control input-sm" v-model="record.service_years"
                            disabled="true" />
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        diff_datetimes(dateThen) {
            ...
            vm.record.institution_years = (days > 0 || months > 0 || years > 0)
        ...
        /**
         * Establece la carga horaria según el cargo seleccionado
         *
         * @author Daniel Contreras <dcontreras@cenditel.gob.ve> | <exodiadaniel@gmail.com>
         */
        setPayrollWorkload() {
