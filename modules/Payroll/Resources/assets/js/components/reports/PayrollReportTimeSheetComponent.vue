<template>
    <section id="PayrollReportTimeSheetsForm">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Desde:</label>
                        <input id="from_date" type="date" name="from_date" class="form-control input-sm"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Hasta:</label>
                        <input id="to_date" type="date" name="to_date" class="form-control input-sm"
                ...
                <div class="col-md-4">
                    <div class="form-group" style="z-index: unset">
                        ...
                        <v-multiselect track_by="text" :options="payroll_supervised_groups"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <v-multiselect track_by="text" :hide_selected="false" :options="payroll_time_parameters"
                            :group_values="'group'" :group_label="'label'" :group_select="true"
                ...
                <div class="col-md-4">
                    <div class="form-group" style="z-index: unset">
                        <label>Estatus</label>
                        <v-multiselect track_by="text" :options="document_status" v-model="record.document_status">
                        </v-multiselect>
                    </div>
                </div>
            </div>
        ...
        <div class="card-footer text-right">
            <button @click.prevent="createReport($event)"
