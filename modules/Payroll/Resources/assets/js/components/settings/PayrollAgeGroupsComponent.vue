<template>
	<section class="text-center" id="payroll_age_group">
		<a class="btn-simplex btn-simplex-md btn-simplex-primary" href=""
		   title="Registros de grupo etario" data-toggle="tooltip"
		   @click="addRecord('add_payroll_age_group', 'payroll/age-groups', $event)">
           <i class="icofont icofont-users-social ico-3x"></i>
		   <span>Grupo etario</span>
		</a>
		<div class="modal fade text-left" tabindex="-1" role="dialog" id="add_payroll_age_group">
				...
				<div class="modal-content">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group is-required">
                                    ...
                                    <input type="text" id="code" placeholder="Código" class="form-control input-sm"
                                        ...
                                        title="Indique el Código del grupo etario (requerido)">
							...
							<div class="col-md-6">
        						<div class="form-group is-required">
        							...
        							<input type="text" id="name" placeholder="Nombre"
        								   ...
        								   title="Indique el nombre del grupo etario (requerido)">
							...
							<div class="col-md-12">
                                <div class="form-group">
        							...
        							<input type="text" id="description" placeholder="Descripción"
        								   ...
        								   title="Indique la descripción del grupo etario">
        	                    </div>
                            </div>
                        </div>
	                </div>
					<div class="modal-footer">
	                	<div class="form-group">
							...
							<button type="button" @click="createRecord('payroll/age-groups')" 
	                ...
	                <div class="modal-body modal-table">
	                	<v-client-table :columns="columns" :data="records" :options="table_options">
	                		<div slot="id" slot-scope="props" class="text-center">
		                		...
		                		<button @click="deleteRecord(props.row.id, 'payroll/age-groups')"
...
<script>
	export default {
		...
		mounted () {
			const vm = this;
			$("#add_payroll_age_group").on('show.bs.modal', function() {
                vm.reset();
            });
		},
	};
