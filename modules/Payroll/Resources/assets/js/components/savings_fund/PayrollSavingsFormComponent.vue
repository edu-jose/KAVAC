    ...
    <section id="PayrollAriRegisterFormComponent">
        <div class="card">
            <div class="card-header">
                <h6 class="card-title">Porcentaje de la cuota del fondo de ahorro.</h6>
                <div class="card-btns">
            ...
            <div class="card-footer text-right">
                ...
                <button type="button" @click="createForm('payroll/savings-fund')"
...
export default {
    ...
    async created() {
        const vm = this;
        await vm.getPayrollStaffs('savings_fund')

        try {
            if (vm.register) {
                vm.record.id = vm.register.id;
                vm.record.percetage = (vm.register.percetage * 100).toFixed(2);
                vm.record.startDate = vm.register.from_date;
                vm.record.endDate = vm.register.to_date;
                vm.record.payroll_staff_id = vm.register.payroll_staff_id;
