...
class AssetFloorController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:asset.setting.floor.create', ['only' => 'store']);
        $this->middleware('permission:asset.setting.floor.edit', ['only' => 'update']);
        $this->middleware('permission:asset.setting.floor.delete', ['only' => 'destroy']);
