  ...
  <section id="AssetReportForm">
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-3">
          <h3 class="h6 mb-2 text-center" style="margin: 0 auto">
            Tipo de Reporte
          </h3>
      ...
      <div :class="isClassification">
        <div
          v-show="this.record.type_report == 'clasification'"
              ...
              <div class="form-group pr-3 px-md-5">
                ...
                <div class="custom-control custom-switch">
                  <input
                    ...
                    v-model="record.type_asset"
                  />
                  <label class="custom-control-label" for="sel_property_report">
                  </label>
                </div>
              </div>
              <div class="form-group pr-3 px-md-5">
                ...
                <div class="custom-control custom-switch">
                  <input
                    ...
                    v-model="record.type_asset"
                  />
                  <label class="custom-control-label" for="sel_vehicle_report">
                  </label>
                </div>
              </div>
              <div class="form-group pr-3 px-md-5">
        ...
        <div
          ...
          v-if="this.record.type_report == 'clasification'"
        ...
        >
          ...
          <div class="col-12 col-md-6 form-group">
            ...
            <select2
              ...
              v-model="record.asset_status_id"
            ></select2>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 form-group">
            ...
            <div class="custom-control custom-switch">
              ...
              />
              <label class="custom-control-label" for="sel_search_date">
              </label>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="custom-control custom-switch">
                <input
                  ...
                  id="sel_search_mes"
                />
                <label class="custom-control-label" for="sel_search_mes">
                </label>
              </div>
            </div>
          </div>
        ...
        <div v-show="this.record.type_search == 'mes'">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label>Mes:</label>
                <select2 :options="mes" v-model="record.mes_id"></select2>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
          ...
          <div class="col-4 col-md-3" id="helpAssetAssetGroupCode">
            <div class="form-group is-required">
              ...
              <input
                ...
                v-model="record.code"
                @input="
                  (event) => (record.code = event.target.value.toUpperCase())
                "
              />
            </div>
          </div>
      ...
      <hr />
      <h3 class="h6 mt-3 card-title text-center">Registros</h3>
      <v-server-table
        :columns="columns"
        :url="url"
        ...
        ref="tableResults"
      >
        <div slot="asset_status.name" slot-scope="props" class="text-center">
          <span>
            {{
...
export default {
  ...
  watch: {
    "record.type_report": function (newVal, oldVal) {
      const vm = this;
      let url = `${window.app_url}/asset/registers/search`;
      if (newVal == "general") {
        vm.url = url + "/general";
  ...
  methods: {
    ...
    async createRecord() {
      const vm = this;
      let fields = {};
      const url = `${window.app_url}/asset/reports`;

      if (
        vm.record.type_report == "clasification" &&
        vm.record.type_asset == ""
      ) {
        bootbox.alert({
          title: "Advertencia",
